...
*/
   ...
   // definir dados
      int x, y, z, a;
   // identificar
      IO.println ( "EXEMPLO0040 - Programa em Java" );
      IO.println ( "Autor: 628826-Rodrigo_P" );
   // ler valor inteiro do teclado
      x=IO.readint("Entrar com a quantidade: ");
      for(y=x;y>=1;y=y-1)
      {
         z = IO.readint ( "Entrar com um valor inteiro impar maior que 35: ");
         a = IO.readint ( "Entrar com um valor inteiro impar maior que 35: ");
         if (z>35&&z%2!=0&&a>35&&a%2!=0)
         {
            IO.println("z="+z+"  "+"a="+a);
         } // fim se
      } // fim repetir
...
/*
   ...
   1.9      01. ( OK )  ler dois valores e mostra-los caso ambos sejam pares e menores que -15 ou maiores que 35                        valores testados:
                        ...
                        0 e 0       nada     
                        -2 e -4     nada
   2.0      01. ( OK )  ler dois valores e mostra-los caso ambos sejam impares e maiores que 35   
                        valores testados:
                        0 e 0:      nada
                        -1 e -3:    nada
                        33 e 31:    nada
