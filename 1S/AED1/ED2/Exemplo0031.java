...
*/
   ...
   // definir dados
      int x, y, z;
   // identificar
      IO.println ( "EXEMPLO0031 - Programa em Java" );
   ...
   // ler valor inteiro do teclado
      ...
      for(y=x;y>=1;y=y-1)
      {
         ...
         if(z<0)
         {
            IO.println("negativo: "+z);
         }
         if (z==0)
         {
         IO.println("Insira apenas valores diferentes de 0");
         }
         if (z>0)
         {
            IO.println("positivo: "+z);
         } // fim se
      } // fim repetir
   // encerrar
      IO.pause ( "Apertar ENTER para terminar." );
   } // fim main( )
} // fim class Exemplo0031
