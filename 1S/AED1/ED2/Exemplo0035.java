...
*/
   ...
   // definir dados
      int x, y, z, a;
   // identificar
      IO.println ( "EXEMPLO0035 - Programa em Java" );
      IO.println ( "Autor: 628826-Rodrigo_P" );
   // ler valor inteiro do teclado
      x=IO.readint("Entrar com a quantidade: ");
      for(y=x;y>=1;y=y-1)
      {
         z = IO.readint ( "Entrar com um valor inteiro par: " );
         a = IO.readint ( "Entrar com um valor inteiro impar: ");
         if (z%2==0&&a%2!=0&&z!=0&&a!=0)
         {
            IO.println("par="+z+"  "+"impar="+a);
         } // fim se
      } // fim repetir
   // encerrar
      IO.pause ( "Apertar ENTER para terminar." );
   } // fim main( )
} // fim class Exemplo0035
