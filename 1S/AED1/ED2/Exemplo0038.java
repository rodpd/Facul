...
*/
   ...
   // definir dados
      int x, y, z, a;
   // identificar
      IO.println ( "EXEMPLO0038 - Programa em Java" );
      IO.println ( "Autor: 628826-Rodrigo_P" );
   // ler valor inteiro do teclado
      x=IO.readint("Entrar com a quantidade: ");
      for(y=x;y>=1;y=y-1)
      {
         z = IO.readint ( "Entrar com um valor inteiro impar entre -16 e 36: ");
         a = IO.readint ( "Entrar com um valor inteiro impar entre -16 e 36: ");
