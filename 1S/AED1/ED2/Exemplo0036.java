...
*/
   ...
   // definir dados
      int x, y, z, a;
   // identificar
      IO.println ( "EXEMPLO0036 - Programa em Java" );
      IO.println ( "Autor: 628826-Rodrigo_P" );
   // ler valor inteiro do teclado
      x=IO.readint("Entrar com a quantidade: ");
      for(y=x;y>=1;y=y-1)
      {
         z = IO.readint ( "Entrar com um valor maior que zero: ");
         a = IO.readint ( "Entrar com um valor menor que o anterior: ");
         if (z>0&&z<a)
         {
            IO.println("z="+z+"  "+"a="+a);
         } // fim se
