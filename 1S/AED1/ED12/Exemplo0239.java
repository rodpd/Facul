 ...
 */
   ...
   public int getQntFones ( )
   {
      return ( this.qntFones );
   }
   public void setQntFones ( int i )
   {
      this.qntFones = i;
   }
   ...
   public void setFone2b ( String s )
   {
      if ( qntFones != 2 )
      {
         IO.println ( "Erro: Nao possui dois telefones " );
      }
      else
      {
         this.fone2 = s;
   ...
   public void setFone2a ( String s )
   {
      if ( qntFones == 1 )
      {
         char c = IO.readchar ( "Quer acrescentar mais um telefone? (y/n) " );
         if ( c == 'y' )
         {
            String t1 = IO.readString ( "Qual o primeiro telefone? " );
            setFone ( t1 );
            setFone2 ( s );
         }
         else
         {
            ...
            {
               IO.println ( "Opcao invalida - digitar apenas y ou n " );
            }
         }
      }
      else
 ...
 */
   ...
   {
   // 1. definir dados
      Contato a1 = new Contato ( "Nome", "", "3333-3333" );
      a1.telefones();
      a1.setFone2a ( "1111-1111" );
      IO.println ( a1 );
      // encerrar
      IO.println ( );
 ...
 */
   ...
   {
   // identificar
      IO.println ( "EXEMPLO0239 - Programa em Java" );
      IO.println ( "Autor: Rodrigo Padilha Fonseca" );
   // criar e executar o metodo auxiliar
      Exemplo0239 m1 = new Exemplo0239 ( );
      m1.metodo19 ( );
   // encerrar
      IO.pause ( "Apertar ENTER para terminar." );
   } // fim main( )
} // fim class Exemplo0239
/*
   Versao   Teste
   19       01
                     Erro: Tamanho de numero invalido // telefone 1 estava vazio no inicio
                     Quer acrescentar mais um telefone? (y/n) y
                     Qual o primeiro telefone? 2222-2222
                     	Nome - 2222-2222 - 1111-1111
