 ...
 */
   ...
   {
   // 1. definir dados
      Contato a1 = new Contato ( "Nome", "1111-1111", "3333-3333" );
      a1.telefones();
      a1.setFone2c ( );
      IO.println ( a1 );
      // encerrar
 ...
 */
   ...
   {
   // identificar
      IO.println ( "EXEMPLO0240 - Programa em Java" );
      IO.println ( "Autor: Rodrigo Padilha Fonseca" );
   // criar e executar o metodo auxiliar
      Exemplo0240 m1 = new Exemplo0240 ( );
      m1.metodo20 ( );
   // encerrar
      IO.pause ( "Apertar ENTER para terminar." );
   } // fim main( )
} // fim class Exemplo0240
/*
   Versao   Teste
   20       01
                     Nome - 1111-1111 - null
