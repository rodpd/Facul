 ...
 */
   ...
   {
   // 1. definir dados
      Contato a1 = new Contato ( "Nome", "2222-2222" );
      a1.toFile ( "Exemplo0235.txt" );
      FILE arquivo = new FILE ( FILE.INPUT, "Exemplo0235.txt" );
      IO.println ( "Nome: " + arquivo.readln( ) );
      IO.println ( "Fone: " + arquivo.readln( ) );
      // encerrar
      IO.println ( );
 ...
 */
   ...
   // criar e executar o metodo auxiliar
      Exemplo0235 m1 = new Exemplo0235 ( );
      m1.metodo15 ( );
   // encerrar
      IO.pause ( "Apertar ENTER para terminar." );
   } // fim main( )
} // fim class Exemplo0235
/*
   Versao   Teste
   15       01
                     Objeto inicial -> Nome, 2222-2222
                     Dados gravados em Exemplo0235.txt:
                     Nome
                     2222-2222
                     Output:
                     Nome: Nome
