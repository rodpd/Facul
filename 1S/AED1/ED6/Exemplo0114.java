...
// ---------------------------------------------- definicao de metodo auxiliar
   ...
   public static void metodo09 ( int x )
   {
      if ( x > 0 )
      {
         IO.print ( "1/"+Math.pow(5,x)+" ");
         metodo09 ( x-1 );
      }
      else
      {
 ...
 */
   ...
   {
   // identificar
      IO.println ( "EXEMPLO0114 - Programa em Java" );
...
/*
   ...
   13          1        Quantidade: 6
                        1 5 10 15 20 25 30
   14          1        Quantidade: 5
                     1/3125.0 1/625.0 1/125.0 1/25.0 1/5.0 1
*/ 
