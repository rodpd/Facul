...
// Matricula: 628826
// TP03 - EX06 - Tabela Hash Direta com Rehash
// Classe Instituicao
class Instituicao
{
   // atributos
...
public class hashDiretaRehash
{
   ...
   {  
      ...
      {
         div = ( inst.codigoMantenedora + 1 ) % 21;
         if ( tabela[div] == null )
         {
            tabela[div] = new Instituicao ( );
            tabela[div] = inst.clone( );
   ...
   {
      hashDiretaRehash inst = new hashDiretaRehash ( 21 );
