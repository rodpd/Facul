...
// Matricula: 628826
// TP03 - EX06 - Tabela Hash Inireta com Lista Simples
// Classe Instituicao
class Instituicao
{
   // atributos
...
// classe hashIndiretaLista
public class hashIndiretaLista
{
   // atributos
   Instituicao[ ] tabela;
   // construtor com tamanho da tabela
   hashIndiretaLista ( int x )
   {
   ...
   {  
      ...
      // caso contrario, verificar posicao da proxima funcao
      else
      {
         Instituicao temp = tabela[div];
         while ( temp.prox != null )
         {
            temp = temp.prox;
         }
         temp.prox = new Instituicao ( );
         temp.prox = inst.clone( );
      }
   }
   public void pesquisar ( String pesquisar )
   {
      ...
      for ( int i = 0; i < 21; i++ )
      {
         ...
         while ( temp != null )
         {
            if ( temp.sigla.compareTo ( pesquisar ) == 0 )
            {
               MyIO.println ( "(" + i + ") " + "SIM" );
               resp = true;
               temp = null;
   ...
   {
      hashIndiretaLista inst = new hashIndiretaLista ( 21 );
