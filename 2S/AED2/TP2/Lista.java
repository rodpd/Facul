...
// Matricula: 628826
// TP01P02 - EX02 - Lista com Alocacao Sequencial
public class Lista implements Cloneable
{
   ...
   public static void inserirInicio ( Lista temp )
   {
   ...
   public static void inserirFim ( Lista temp )
   {
      ultimo.prox = temp;
      temp.prox = null;
      ultimo = temp;
   ...
   public static void inserir ( Lista inst, int posicao )
   {
      Lista temp = primeiro;
   ...
   public static void main ( String [] args )
   {
      ...
      // print do array
      for ( Lista i = inst.primeiro; i != null; i = i.prox )
      {
         i.imprimir( );
      }
   }
