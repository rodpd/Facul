...
public class FilaFlexivel implements Cloneable
{
   // atributos
   public static int ultimo;
   public static FilaFlexivel [] inst;
   public static FilaFlexivel [] retornada;
   private int codigo;
   private String nome;
   ...
   private FilaFlexivel primeira;
   private FilaFlexivel prox;
   // construtor vazio
   void FilaFlexivel ( )
   {
      this.codigo = 0;
   ...
   public FilaFlexivel clone ( )
   {
      FilaFlexivel Instituicao = new FilaFlexivel ( );
   ...
   {
      inst = new FilaFlexivel[200];
      retornada = new FilaFlexivel[20];
      FilaFlexivel Instituicao = new FilaFlexivel ( );
      ultimo = -1;
      ...
      while ( num > 0 )
      {
         inst[ultimo+1] = new FilaFlexivel ( );
      ...
      for ( int i = MyIO.readInt( ); i > 0; i-- )
      {
         ...
         // e imprimidos ao serem retornados
            retornada[retornadas] = new FilaFlexivel ( );
      ...
      FilaFlexivel [ ] Circular = new FilaFlexivel[5];
      Circular [0] = new FilaFlexivel ( );
      Circular [1] = new FilaFlexivel ( );
      Circular [2] = new FilaFlexivel ( );
      Circular [3] = new FilaFlexivel ( );
      Circular [4] = new FilaFlexivel ( );
