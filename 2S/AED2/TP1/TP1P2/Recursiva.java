...
// Matricula: 628826
// TP01P02 - EX09 - Ordenacao por Selecao Recursiva Recursiva
public class Recursiva implements Cloneable
{
	// atributos
	public static int ultimo;
	public static Recursiva [] inst;
	public static Recursiva [] retornada;
	...
	public Recursiva clone ( )
	{
		Recursiva Instituicao = new Recursiva ( );
	...
	public static void main ( String [] args )
	{
		...
		{
			comparacoes += 1;
			inst[ultimo+1] = new Recursiva ( );
			inst[ultimo+1].ler(num);
			ultimo += 1;
			num = MyIO.readInt( );
		}
		MyIO.println ( "antes de ordenar:" );
		for ( int i = 0; i <= ultimo; i++ )
		{
			//inst[i].imprimir( );
			MyIO.println ( inst[i].getCodigo( ) );
		}
		MyIO.println ( "depois de ordenar:" );
