...
// Matricula: 628826
// TP01P02 - EX01 - Classe
public class Instituicao implements Cloneable
{
	// atributos
   private int codigo;
   private String nome;
   ...
   public static void main ( String [] args )
   {
      ...
      // continuar lendo e imprimindo enquanto input nao for 0
      while ( num != 0 )
      {
         inst.ler (num);
         inst.imprimir( );
