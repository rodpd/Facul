...
public class MainActivity extends AppCompatActivity
    ...
    private ImageView imageSom;
    private ImageView imageAdivinha;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageSom = findViewById(R.id.image_sons);
        imageSom.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MainActivity.this, Tela2.class));
            }
        });
        imageAdivinha = findViewById(R.id.image_adivinha);
